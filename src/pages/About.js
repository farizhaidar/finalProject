  ...
  return (
    <div className="mx-auto py-4 h-auto w-screen background1">
      <div>
        ...
        <h1 className="text-4xl font-bold mb-4 p-4">Tentang TIK</h1>
        ...
        <div className="flex flex-wrap">
          ...
          <div className="w-full md:w-1/2 pl-4">
            <h2 className="text-2xl font-bold mb-2">Kisah Kami</h2>
            <p className="mb-4 mr-8 text-justify">
              Jurusan Teknik Informatika dan Komputer (TIK) diresmikan pada 2 Juni 2014 dengan tujuan untuk menghasilkan lulusan sarjana sains terapan yang berpengalaman dan mampu memecahkan masalah dalam bidang Teknik Informatika dan Komputer dengan menganalisis, merancang, dan membangun sistem.
            ...
            <p className='mr-8 text-justify'>
              ...
              Mengembangkan penelitian dan penerapan ilmu pengetahuan dan teknologi serta produk inovasi berkualitas di bidang Teknologi Informasi dan Komputer.
              Mengembangkan institusi yang efisien, efektif, dan akuntabel berbasis ICT (Information Communication Technology).
            </p>
          </div>
        </div>
        {/* Bagian kepala jurusan */}
